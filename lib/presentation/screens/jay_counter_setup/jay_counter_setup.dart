...
import 'package:classical_bluetooth_app/presentation/ui_logic_holders/jay_counter_setup_form_bloc/jay_counter_setup_form_bloc.dart';
    ...
    return BlocConsumer<BtBondingCubit, BtBondingState>(
      listener: (context, btBondingState) => _showSnackBar(
        ...
        btBondingState.when(
          ...
          failure: () => 'Hubo un error al emparejar. Inténtelo nuevamente.',
        ),
      ),
...
class _ConnectionScaffoldBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<BtConnectionCubit, BtConnectionState>(
      listener: (context, btConnectionState) => _showSnackBar(
        context,
...
class _JayCounterSetupForm extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return FormBlocListener<JayCounterSetupFormBloc, String, String>(
